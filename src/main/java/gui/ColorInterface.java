...
/*
Интерфейс, который определяет набор константных строковых значений.
...
public interface ColorInterface {
    ...
    String BoxBackgroundColor = "#fafafa;"; // Легкий серый, чтобы создать карточку игры, отделив ее от заднего плана
}
